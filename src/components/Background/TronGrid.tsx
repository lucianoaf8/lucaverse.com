...
export default function TronGridAICircuitBackground() {
  return (
    <div style={{ position: 'absolute', top: 0, left: 0, width: '100%', height: '100%', backgroundColor: '#040810', overflow: 'hidden' }}>
      <SubtleTronGrid />
      
      {/* Optional overlay for additional depth */}
      <div style={{ position: 'absolute', top: 0, left: 0, width: '100%', height: '100%', background: 'linear-gradient(to bottom right, transparent, transparent, rgba(0, 0, 50, 0.1))', pointerEvents: 'none' }} />
    </div>
  );
}